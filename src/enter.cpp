...
void HistoryLineEdit::keyPressEvent(QKeyEvent* ev)
      ...
      if (ev->key() == Qt::Key_Up) {
            ...
            switch (ev->key()) {
                  ...
                  case Qt::Key_Return:
                  case Qt::Key_F4:
                  case Qt::Key_Select: completer->popup()->hide(); return;
                  }
            }
      // QLineEdit does strange things with TAB (looses focus)
...
void HistoryLineEdit::setWordCompleter(QCompleter* comp)
      ...
      if (comp) {
            ...
            connect(completer, SIGNAL(activated(QString)), this, SLOT(autocomplete(QString)));
            connect(completer, SIGNAL(highlighted(QString)), this, SLOT(autocomplete(QString)));
