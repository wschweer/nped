...
class MarkerDefinitions : public std::array<MarkerDefinition, 7>
    ...
    public:
      void setDarkMode(bool dark) {
            ...
            (*this)[5] = {dark ? QColor(0, 0, 0) : QColor(255, 255, 255), dark ? QColor(150, 150, 150) : QColor(120, 120, 120), false,
                          false}; // search
            (*this)[6] = {dark ? QColor(0, 0, 0) : QColor(255, 255, 255), dark ? QColor(150, 150, 220) : QColor(120, 120, 220), false,
                          false}; // search hit
            }
